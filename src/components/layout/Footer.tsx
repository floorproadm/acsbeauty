...
export function Footer() {
  ...
  return (
    <footer className="bg-neutral-800 text-background">
      <div className="container mx-auto px-5 md:px-6 py-10 md:py-16">
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="col-span-2 md:col-span-1 space-y-3 md:space-y-4">
            ...
            <div className="flex gap-3 md:gap-4 pt-1 md:pt-2">
              <a
                ...
                className="p-2 rounded-full bg-background/10 hover:bg-gold hover:text-foreground transition-all duration-300"
          ...
          <div className="space-y-3 md:space-y-4">
            ...
            <nav className="flex flex-col gap-2">
              <Link
                to="/services"
                className="text-background/70 hover:text-gold text-xs md:text-sm transition-colors font-light"
              >
                {t("nav.services")}
              </Link>
              <Link
          ...
          <div className="space-y-3 md:space-y-4">
            ...
            <nav className="flex flex-col gap-2">
              <span className="text-background/70 text-xs md:text-sm font-light">
          ...
          <div className="space-y-3 md:space-y-4">
            ...
            <div className="space-y-2 md:space-y-3">
              <a
                ...
                className="flex items-center gap-2 md:gap-3 text-background/70 hover:text-gold text-xs md:text-sm transition-colors font-light"
              >
              ...
              <a
                ...
                className="flex items-center gap-2 md:gap-3 text-background/70 hover:text-gold text-xs md:text-sm transition-colors break-all font-light"
              >
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-start gap-2 md:gap-3 text-background/70 text-xs md:text-sm hover:text-gold transition-colors font-light"
              >
        ...
        {/* Bottom Bar */}
        <div className="border-t border-background/10 mt-8 md:mt-12 pt-6 md:pt-8 flex flex-col md:flex-row justify-between items-center gap-3 md:gap-4">
          <p className="text-background/50 text-xs md:text-sm text-center md:text-left font-light">
            {t("global.copyright", { year: new Date().getFullYear() })}
          </p>
          <div className="flex gap-4 md:gap-6">
            <Link
              to="/privacy"
              className="text-background/50 hover:text-gold text-xs md:text-sm transition-colors font-light"
            >
