...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "about.bridge_description": "Get to know the founder and the team that brings this vision to life every day.",
    ...
    "review.ane_quote": "Every client who sits in my chair is personal to me. If I delivered a great experience, sharing your story helps other women find the same care for themselves. It takes just 2 minutes and means the world to our small team.",
  ...
  pt: {
    ...
    "about.bridge_description": "Conheça a fundadora e a equipe que dá vida a essa visão todos os dias.",
    ...
    "review.ane_quote": "Cada cliente que senta na minha cadeira é especial para mim. Se proporcionei uma ótima experiência, compartilhar sua história ajuda outras mulheres a encontrarem o mesmo cuidado. Leva só 2 minutinhos e significa o mundo para nossa pequena equipe.",
