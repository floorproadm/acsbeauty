    ...
    Tables: {
      ...
      blog_posts: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "blog_posts_related_service_id_fkey"
      ...
      service_skus: {
        ...
        Relationships: [
          {
            foreignKeyName: "service_skus_service_id_fkey"
            columns: ["service_id"]
            isOneToOne: false
            referencedRelation: "services"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "service_skus_variation_id_fkey"
      ...
      staff_services: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "staff_services_team_member_id_fkey"
      ...
      whatsapp_clicks: {
        ...
        Relationships: [
          {
            foreignKeyName: "whatsapp_clicks_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
            referencedRelation: "clients"
            referencedColumns: ["id"]
