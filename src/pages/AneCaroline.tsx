...
const c = {
  bg: "#e8e3dd",          // warm gray page background
  dark: "#3d3d38",        // warm charcoal for dark sections
  cream: "#f5f0eb",       // cream for text on dark
  mutedDark: "#b8b3ab",   // muted on dark bg
  textDark: "#2a2a26",    // dark text on light bg
  mutedLight: "#8a8580",  // muted text on light bg
  accent: "#8b7355",      // warm brown for italic accents
  border: "#d5cec5",      // border on light
  borderDark: "#55554f",  // border on dark
};
      ...
      <section className="px-8 pt-6 pb-12 max-w-lg mx-auto" style={{ backgroundColor: c.bg }}>
        ...
        >
          ...
          <div className="space-y-3 text-[13px] leading-[1.7]" style={{ color: c.mutedLight }}>
            ...
            <p>
              Ainda criança, já cortava o cabelo das minhas irmãs,
              sem técnica, mas com muito cuidado.
            </p>
            <p>Com o tempo, esse gesto se transformou em profissão.</p>
            <p>
              Desde 2016 venho construindo minha trajetória na
              área, formando uma clientela fiel e aprimorando
              constantemente minha técnica.
            </p>
            <p>
              Hoje, na ACS Beauty sigo fazendo o que sempre me
              guiou: cuidar de pessoas através do meu trabalho.
            </p>
          </div>
        </motion.div>
      </section>
        ...
        <div className="px-8 py-12 max-w-lg mx-auto">
          ...
          >
            ...
            <div className="space-y-3 text-[13px] leading-[1.7]" style={{ color: c.mutedDark }}>
              <p>
                Minha missão é cuidar de cada pessoa que passa
                pela minha cadeira com atenção, sensibilidade e
                excelência.
              </p>
              <p>
                Acredito que o cabelo vai muito além da estética.
                Ele expressa identidade, autoestima e confiança.
              </p>
              <p>Por isso, meu compromisso é oferecer mais do que um serviço.</p>
              <p>
                Quero proporcionar uma experiência onde cada
                cliente se sinta valorizada, segura e ainda mais
                confiante com quem é.
              </p>
            </div>
          </motion.div>
        </div>
