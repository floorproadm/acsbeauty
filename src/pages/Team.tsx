                ...
                {members.map((member, idx) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="flex items-center gap-4 p-4 rounded-2xl bg-card border border-border hover:shadow-card transition-all duration-300"
                    >
                      {member.page_url ? (
                        <Link to={member.page_url} className="flex-1 min-w-0 hover:opacity-70 transition-opacity">
                      ...
                      {whatsappUrl && (
                        <a
                          ...
                          className="shrink-0 w-10 h-10 rounded-full bg-[#25D366]/10 flex items-center justify-center hover:bg-[#25D366]/20 transition-colors"
