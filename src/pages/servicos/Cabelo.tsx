...
export default function Cabelo() {
  ...
  const services = [
    t("servicos.cabelo.service_1"),
    t("servicos.cabelo.service_2"),
    t("servicos.cabelo.service_3"),
    t("servicos.cabelo.service_4"),
    t("servicos.cabelo.service_5"),
    t("servicos.cabelo.service_6"),
    t("servicos.cabelo.service_7"),
    t("servicos.cabelo.service_8"),
  ];

  const idealFor = [
    t("servicos.cabelo.ideal_1"),
    t("servicos.cabelo.ideal_2"),
    t("servicos.cabelo.ideal_3"),
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            >
              <h2 className="font-serif text-2xl md:text-3xl font-bold mb-6 text-foreground">
                {t("servicos.cabelo.about_title")}
              </h2>
              <p className="text-muted-foreground text-lg leading-relaxed">
                {t("servicos.cabelo.about_text")}
              </p>
            </motion.div>
          </div>
        </section>
